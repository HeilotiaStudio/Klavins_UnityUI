...
using TMPro; // Ja lieto TextMeshPro (ieteicams)
using System;
...
public class CharacterInfo : MonoBehaviour
{
    ...
    [Header("Settings")]
    [SerializeField] private string characterPrefix = "Supervaronis"; // Priedēklis
    ...
    // Opcija: Notīrīt laukus
    public void ClearFields()
    {
        if (nameInput != null) nameInput.text = "";
        if (yearInput != null) yearInput.text = "";
        if (resultText != null) resultText.text = "Ievadiet vārdu un dzimšanas gadu!";
    }
}
